...
// Generic paginated list for models created via createCRUDController
const paginatedList = async (Model, req, res) => {
  try {
    ...
    // Determine if current user should be restricted to own documents
    ...
    return res.status(500).json({
      success: false,
      result: null,
      message: 'Server error in paginated list',
    });
  }
};
